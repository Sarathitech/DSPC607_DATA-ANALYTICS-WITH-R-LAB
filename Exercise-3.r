#  Ex3a. Create a data frame called student data, explore the structure of the data and process it using data.frame.
...
# Ex3b. Load the Student dataset from folder, explore the structure of the dataset and process it using read.table.
...
Total = sdata$m1+sdata$m2+sdata$m3+sdata$m4+sdata$m5
ptge = Total/5
sdata = cbind(sdata,Rvec,Total,ptge)
sdata